...
class BaseSZZ(AbstractSZZ):
    ...
    * ignore_revs_file_path
    ...
    def __init__(self, repo_full_name: str, repo_url: str, repos_dir: str = None, logger: logging.Logger = None):
    ...
    def find_bic(self, fix_commit_hash: str, impacted_files: List['ImpactedFile'], **kwargs) -> Set[Commit]:
        ...
        self.logger.info(f"find_bic() kwargs: {kwargs}")
        ...
        if kwargs.get('issue_date_filter', False):
            ...
            self.logger.info("Not filtering by issue date.")
